...
<template>
  <header class="bg-bg-base z-10 mb-16px pt-16px px-32px sticky -top-52px border-b-gray-200 dark:border-b-dark-200 border-b-1px border-solid transition-shadow duration-300" :class="{ 'shadow-md shadow-gray-100 dark:shadow-transparent': !visible }">
