...
export const AUTHOR_EMAIL = process.env.VITE_EMAIL as string
export const AUTHOR_NAME = process.env.VITE_AUTHOR as string
export const AUTHOR_DOMAIN = process.env.VITE_DOMAIN as string
